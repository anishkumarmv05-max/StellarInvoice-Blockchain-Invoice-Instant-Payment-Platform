...
export default function Dashboard() {
  ...
  const handleExportCSV = () => {
    const headers = ["Invoice Number", "Client Name", "Amount", "Currency", "Status"];
    const rows = invoices.map(i => [i.invoiceNumber, i.clientName, i.totalAmount, i.currency, i.status]);
        ...
        {user?.role === "freelancer" && (
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-2 bg-slate-100 text-slate-700 px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-slate-200 w-fit"
            >
